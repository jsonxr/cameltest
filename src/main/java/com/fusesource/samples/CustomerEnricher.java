...
//        oldExchange.getOut().setBody(newExchange.getIn().getBody(String.class));
        ...
        System.out.println("oldExcehange.getIn(): " + oldExchange.getIn());
        System.out.println("newExchange.getIn(): " + newExchange.getIn());
        System.out.println("newExchange.getIn().getBody(String.class): " + newExchange.getIn().getBody(String.class));
